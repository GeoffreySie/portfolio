...
export function ExperienceList() {
  const [active, setActive] = useState<(typeof experience)[number] | boolean | null>(
    null
  );
        ...
        {experience.map((card, index) => (
          ...
          >
            ...
            <motion.p
              ...
              className="px-4 py-2 text-sm font-bold text-neutral-700 dark:text-white mt-4 md:mt-0"
            >
              {card.date}
            </motion.p>
          </motion.div>
